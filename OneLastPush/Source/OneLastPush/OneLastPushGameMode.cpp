...
void AOneLastPushGameMode::ItemUsed(int32 Value)
{
...
void AOneLastPushGameMode::ScoreUpdate(int32 Value)
{
...
void AOneLastPushGameMode::ResetComboCooldown()
{
	// reset the combo cooldown timer
	GetWorld()->GetTimerManager().SetTimer(ComboTimer, this, &AOneLastPushGameMode::ResetCombo, ComboCooldown, false);
}

void AOneLastPushGameMode::ResetCombo()
{
...
bool AOneLastPushGameMode::CanSpawnNPCs()
{
	// is the NPC counter under the cap?
	return NPCCount < NPCCap;
}

void AOneLastPushGameMode::IncreaseNPCs()
{
	// increase the NPC counter
	++NPCCount;
}

void AOneLastPushGameMode::DecreaseNPCs()
{
