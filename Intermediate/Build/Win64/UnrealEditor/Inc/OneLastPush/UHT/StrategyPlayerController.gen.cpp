...
ONELASTPUSH_API UClass* Z_Construct_UClass_AStrategyPlayerController();
ONELASTPUSH_API UClass* Z_Construct_UClass_AStrategyPlayerController_NoRegister();
ONELASTPUSH_API UClass* Z_Construct_UClass_AStrategyUnit_NoRegister();
ONELASTPUSH_API UEnum* Z_Construct_UEnum_OneLastPush_EStrategyInputMode();
...
static UEnum* EStrategyInputMode_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OneLastPush_EStrategyInputMode, (UObject*)Z_Construct_UPackage__Script_OneLastPush(), TEXT("EStrategyInputMode"));
	}
	return Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton;
}
template<> ONELASTPUSH_NON_ATTRIBUTED_API UEnum* StaticEnum<EStrategyInputMode>()
{
	return EStrategyInputMode_StaticEnum();
}
struct Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_OneLastPush,
	nullptr,
	"EStrategyInputMode",
	"EStrategyInputMode",
	Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_OneLastPush_EStrategyInputMode()
{
	if (!Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton, Z_Construct_UEnum_OneLastPush_EStrategyInputMode_Statics::EnumParams);
	}
...
// ********** Begin Function BP_CursorFeedback constinit property declarations *********************
...
// ********** End Function BP_CursorFeedback constinit property declarations ***********************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function BP_CursorFeedback Property Definitions ********************************
...
// ********** End Function BP_CursorFeedback Property Definitions **********************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AStrategyPlayerController, nullptr, "BP_CursorFeedback", 	Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback_Statics::PropPointers), 
sizeof(StrategyPlayerController_eventBP_CursorFeedback_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08880800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback_Statics::Function_MetaDataParams), Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AStrategyPlayerController, nullptr, "OnMoveCompleted", 	Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::StrategyPlayerController_eventOnMoveCompleted_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::Function_MetaDataParams), Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted_Statics::Function_MetaDataParams)},  };
...
struct Z_Construct_UClass_AStrategyPlayerController_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TouchTapMaxAllowedTime_MetaData[] = {
		{ "Category", "Touch Input" },
		{ "ClampMax", "1" },
		{ "ClampMin", "0" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Max time between touch press and release to be considered a tap */" },
#endif
		{ "ModuleRelativePath", "Variant_Strategy/StrategyPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Max time between touch press and release to be considered a tap" },
#endif
		{ "Units", "s" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TouchDoubleTapMaxAllowedTime_MetaData[] = {
		{ "Category", "Touch Input" },
		{ "ClampMax", "1" },
		{ "ClampMin", "0" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Max time between touchscreen taps to be considered a double tap */" },
#endif
		{ "ModuleRelativePath", "Variant_Strategy/StrategyPlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Max time between touchscreen taps to be considered a double tap" },
#endif
		{ "Units", "s" },
	};
#endif // WITH_METADATA

// ********** Begin Class AStrategyPlayerController constinit property declarations ****************
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_TouchTapMaxAllowedTime;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_TouchDoubleTapMaxAllowedTime;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class AStrategyPlayerController constinit property declarations ******************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("OnMoveCompleted"), .Pointer = &AStrategyPlayerController::execOnMoveCompleted },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AStrategyPlayerController_BP_CursorFeedback, "BP_CursorFeedback" }, // 3484783396
		{ &Z_Construct_UFunction_AStrategyPlayerController_OnMoveCompleted, "OnMoveCompleted" }, // 271956379
	};
...
// ********** Begin Class AStrategyPlayerController Property Definitions ***************************
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, InputMode), Z_Construct_UEnum_OneLastPush_EStrategyInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputMode_MetaData), NewProp_InputMode_MetaData) }; // 813928344
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_SelectionTraceChannel = { "SelectionTraceChannel", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, SelectionTraceChannel), Z_Construct_UEnum_Engine_ETraceTypeQuery, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SelectionTraceChannel_MetaData), NewProp_SelectionTraceChannel_MetaData) }; // 93441085
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_TouchTapMaxAllowedTime = { "TouchTapMaxAllowedTime", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, TouchTapMaxAllowedTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TouchTapMaxAllowedTime_MetaData), NewProp_TouchTapMaxAllowedTime_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_TouchDoubleTapMaxAllowedTime = { "TouchDoubleTapMaxAllowedTime", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, TouchDoubleTapMaxAllowedTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TouchDoubleTapMaxAllowedTime_MetaData), NewProp_TouchDoubleTapMaxAllowedTime_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AStrategyPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_TouchTapMaxAllowedTime,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_TouchDoubleTapMaxAllowedTime,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AStrategyPlayerController_Statics::PropPointers) < 2048);
// ********** End Class AStrategyPlayerController Property Definitions *****************************
...
void AStrategyPlayerController::StaticRegisterNativesAStrategyPlayerController()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_AStrategyPlayerController_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, AStrategyPlayerController);
AStrategyPlayerController::~AStrategyPlayerController() {}
// ********** End Class AStrategyPlayerController **************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStrategyInputMode_StaticEnum, TEXT("EStrategyInputMode"), &Z_Registration_Info_UEnum_EStrategyInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 813928344U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyPlayerController, AStrategyPlayerController::StaticClass, TEXT("AStrategyPlayerController"), &Z_Registration_Info_UClass_AStrategyPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyPlayerController), 2358953972U) },
	};
}; // Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_3421962618{
	TEXT("/Script/OneLastPush"),
	Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Games_OneLastPush_Source_OneLastPush_Variant_Strategy_StrategyPlayerController_h__Script_OneLastPush_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
